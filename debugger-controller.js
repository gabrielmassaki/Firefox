...
Tracer.prototype = {
  ...
  connect: function() {
    ...
    /* Gabriel added */
    this.client.addListener("websocketmessages", this.onWebSocketInspector);
  },
  ...
  disconnect: function() {
    ...
    /* Gabriel added */
    this.client.removeListener("websocketmessages", this.onWebSocketInspector);
  },
  ...
  /* Gabriel added */
  onWebSocketInspector: function (aEvent, { from, message }) {
    dump(from + "\n");
    dump(message.type + "\n");
