...
class EventTestDispatcher : public nsRunnable
{
  public:
    explicit EventTestDispatcher(int num)
      : mNum(num) {}
    ...
    NS_IMETHODIMP Run()
    {
      ...
      nsAutoString value;
      value.AppendInt(mNum);
      return obsService->NotifyObservers(nullptr, "event-test-websocket", value.get());
    }
...
WebSocket::Disconnect()
{
  ...
  /* Gabriel added */
  NS_DispatchToMainThread(new EventTestDispatcher(int(333)));
  /* End of Gabriel added */
